              ...
              <div>
                {
                  ...
                  <div className="mt-6 sm:flex sm:items-center sm:justify-between ">
                    <div className="text-sm text-gray-500 ">
                        Showing <span className="font-medium text-gray-700 ">{indexOfFirstPost2 + 1} to {(indexOfLastPost2 > filteredOrders.length) ? (indexOfLastPost - (indexOfLastPost2 - filteredOrders.length)) : indexOfLastPost2} of {filteredOrders.length}</span> 
                    </div>
                      ...
                      <div className="mt-6 sm:flex sm:items-center sm:justify-between ">
                      <div className="text-sm text-gray-500 ">
                          Showing <span className="font-medium text-gray-700 ">{indexOfFirstPost + 1} to {(indexOfLastPost > totalPosts) ? (indexOfLastPost - (indexOfLastPost - totalPosts)) : indexOfLastPost} of {totalPosts}</span> 
                      </div>
