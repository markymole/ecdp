            ...
            <div className="h-full overflow-y-auto">
                ...
                <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
                    ...
                    <div>
                        ...
                        {product_orders?.filter(product_order => product_order.assembly_one === null  && product_order.assembly_prep === "Ok").length}
                        </p>
                    </div>
                    </div>
                    <div className="flex items-center p-4 rounded-lg shadow-xs bg-gray-700">
                    ...
                    <div>
                        ...
                        <p className="text-lg font-semibold text-gray-200">
                        {product_orders?.filter(product_order => product_order.assembly_one === "In-Progress" && product_order.assembly_prep === "Ok").length}
                        </p>
                    </div>
                    </div>
                    <div className="flex items-center p-4 rounded-lg shadow-xs bg-gray-700">
                        ...
                        return(
                                 <div  key={order.id} className="m-auto h-52 w-full max-w-md bg-white shadow-md p-2 border-t-4 border-green-600 rounded hover:scale-105 duration-300 transition-all ease-out">
                                        ...
                                        <div className="flex flex-wrap justify-between p-2 w-full gap-4">
                                            ...
                                            <div className="flex flex-col mr-2">
                                                    <h4 className="text-xs">Date Assembled</h4>
                                                    <h1 className="text-md">{order.date_assembled_one}</h1>
                                            </div>
                                        </div>
